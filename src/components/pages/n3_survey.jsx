  ...
  return (
    <section className="survey-page" style={display}>
      ...
      <form>
        ...
        <div className="survey-question">
          <p>
            Question 3: How often do you use the following functions?
            <br />( 1 = never/seldom; 2 = sometimes; 3 = often )
          </p>
          <div className="survey-options">
            <input
              type="radio"
          ...
          <div className="survey-options">
            <input
              ...
              name="q3b"
              value="1"
              onChange={(e) => setq3b(e.target.value)}
            />
            <input
              type="radio"
              name="q3b"
